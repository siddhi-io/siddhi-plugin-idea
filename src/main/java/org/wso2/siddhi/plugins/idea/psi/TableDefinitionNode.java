...
/**
 * Represents table_definition rule in parser.
 */
public class TableDefinitionNode extends IdentifierDefSubtree implements TopLevelDefinition, ParameterContainer {
    public TableDefinitionNode(@Nonnull ASTNode node) {
