...
public class SiddhiAutoImportConfigurable implements SearchableConfigurable {

    private JCheckBox myCbShowImportPopup;
    private JCheckBox myCbAddUnambiguousImports;

    @NotNull
    private final SiddhiCodeInsightSettings myCodeInsightSettings;
    private final boolean myIsDialog;

    public SiddhiAutoImportConfigurable(@NotNull Project project, boolean dialogMode) {
        myCodeInsightSettings = SiddhiCodeInsightSettings.getInstance();
