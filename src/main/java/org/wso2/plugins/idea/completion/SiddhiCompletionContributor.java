...
public class SiddhiCompletionContributor extends CompletionContributor {
    ...
    public void fillCompletionVariants(@NotNull CompletionParameters parameters, @NotNull CompletionResultSet result) {
        ...
        if (parent instanceof StreamIdNode) {
            streamIdNode(parameters, result);
        }
...
//        }
     ...
     */
    private void streamIdNode(@NotNull CompletionParameters parameters,
                                       @NotNull CompletionResultSet resultSet) {
        PsiElement element = parameters.getPosition();
        PsiElement parent = element.getParent();
        PsiElement superParent = parent.getParent();
        // Check whether we are in a package declaration node
        if (superParent.getParent() instanceof StreamIdNode) {
...
//                                             @NotNull CompletionResultSet resultSet) {
//        PsiElement element = parameters.getPosition();
//        PsiDirectory[] psiDirectories = SiddhiPsiImplUtil.suggestImportPackages(element);
//        for (PsiDirectory directory : psiDirectories) {
//            InsertHandler<LookupElement> insertHandler;
//            if (SiddhiPsiImplUtil.hasSubdirectories(directory)) {
//                insertHandler = ImportCompletionInsertHandler.INSTANCE_WITH_AUTO_POPUP;
//            } else {
//                insertHandler = StatementCompletionInsertHandler.INSTANCE;
//            }
