...
//import org.wso2.plugins.idea.psi.impl.BallerinaElementFactory;
//import org.wso2.plugins.idea.psi.impl.BallerinaPsiImplUtil;
...
//                                PsiElement identifier = SiddhiElementFactory.createIdentifier(project, alias);
...
//            return;
//        }
//        String importPath =SiddhiUtil.suggestPackageNameForDirectory(((PsiDirectory) element));
//        if (StringUtil.isEmpty(importPath)) {
//            return;
//        }
//        ApplicationManager.getApplication().runWriteAction(() -> {
//            SiddhiPsiImplUtil.addImport(file, importPath, alias);
//        });
//    }
//
